...
[
	...
	{id:"mainbg", size:456, src:"game_bg_2_hd.jpg?"+Math.random()},

	{id:"bottom", size:50, src:"bottom.png?"+Math.random()},

	{id:"fish1", size:6, src:"fish1.png?"+Math.random()},

	{id:"fish2", size:16, src:"fish2.png?"+Math.random()},

	{id:"fish3", size:11, src:"fish3.png?"+Math.random()},

	{id:"fish4", size:15, src:"fish4.png?"+Math.random()},

	{id:"fish5", size:43, src:"fish5.png?"+Math.random()},

	{id:"fish6", size:45, src:"fish6.png?"+Math.random()},

	{id:"fish7", size:80, src:"fish7.png?"+Math.random()},

	{id:"fish8", size:100, src:"fish8.png?"+Math.random()},

	{id:"fish9", size:104, src:"fish9.png?"+Math.random()},

	{id:"fish10", size:121, src:"fish10.png?"+Math.random()},

	{id:"shark1", size:287, src:"shark1.png?"+Math.random()},

	{id:"shark2", size:382, src:"shark2.png?"+Math.random()},

	{id:"cannon1", size:11, src:"cannon1.png?"+Math.random()},

	{id:"cannon2", size:11, src:"cannon2.png?"+Math.random()},

	{id:"cannon3", size:11, src:"cannon3.png?"+Math.random()},

	{id:"cannon4", size:13, src:"cannon4.png?"+Math.random()},

	{id:"cannon5", size:13, src:"cannon5.png?"+Math.random()},

	{id:"cannon6", size:15, src:"cannon6.png?"+Math.random()},

	{id:"cannon7", size:17, src:"cannon7.png?"+Math.random()},

	{id:"bullet", size:8, src:"bullet.png?"+Math.random()},

	{id:"web", size:93, src:"web.png?"+Math.random()},

	{id:"numBlack", size:1, src:"number_black.png?"+Math.random()},

	{id:"coinAni1", size:19, src:"coinAni1.png?"+Math.random()},

	{id:"coinAni2", size:22, src:"coinAni2.png?"+Math.random()},

	{id:"coinText", size:16, src:"coinText.png?"+Math.random()}
